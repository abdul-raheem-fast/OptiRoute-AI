...
notebook_path = r"D:\Datasets (FYP)\model_accuracy_analysis.ipynb"
...
nb_content = {
    "cells": [
        ...
        },
        {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {"id": "cell_2_accuracy_graphs"},
            "outputs": [],
            "source": [
        ...
        },
        {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {"id": "cell_3_cost_latency_graphs"},
            "outputs": [],
            "source": [
        ...
        },
        {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {"id": "cell_4_tradeoff_plots"},
            "outputs": [],
            "source": [
        ...
        },
        {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {"id": "cell_5_summary_table"},
            "outputs": [],
            "source": [
...
print("✓ Successfully updated model_accuracy_analysis.ipynb with Accuracy, Cost, and Latency cells!")
